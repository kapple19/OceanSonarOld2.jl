...
oceanography = [
    "Introduction" => "oceanography.md"
    "Surface" => [
        "Introduction" => "oceanography/surface.md"
...
acoustics = [
    "Introduction" => "acoustics.md"
    "Reflection" => [
        "Introduction" => "acoustics/reflection.md"
